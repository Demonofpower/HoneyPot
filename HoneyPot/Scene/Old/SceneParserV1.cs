...
namespace HoneyPot.Scene.Old
{
    class SceneParserV1
    {
        ...
        public SceneParserV1(DebugLog debugLog, SelectionManager selectionManager)
        {
        ...
        public List<SceneStep> Parse(string path)
        {
            ...
            for (int i = 0; i < scene.steps.Count; i++)
            {
                ...
                if (step != null)
                {
                    ...
                    currSceneDef.steps.Add(new SceneCreatorV1(debugLog, selectionManager).WaitStep(1));
                }
            }
        ...
        {
            var creator = new SceneCreatorV1(debugLog, selectionManager);
        ...
        private List<DialogSceneStep> CreateSteps(List<Step> steps)
        {
            ...
            dialogSteps.Add(new SceneCreatorV1(debugLog, selectionManager).WaitStep(1));
