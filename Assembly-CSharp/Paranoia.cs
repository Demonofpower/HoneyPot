...
public class Paranoia : MonoBehaviour
{
	...
	{
		Rect clientRect = new Rect(120f, 20f, 120f, 100f);
	...
	private void DoPuzzle(int windowID)
	{
		...
		{
			GameManager.System.Puzzle.Game.SetResourceValue(PuzzleGameResourceType.MOVES, int.Parse(this.newMoves), true);
		...
		{
			GameManager.System.Puzzle.Game.SetResourceValue(PuzzleGameResourceType.AFFECTION, int.Parse(this.newAffection), true);
		...
		{
			GameManager.System.Puzzle.Game.SetResourceValue(PuzzleGameResourceType.PASSION, int.Parse(this.newPassion), true);
		...
		{
			GameManager.System.Puzzle.Game.SetResourceValue(PuzzleGameResourceType.SENTIMENT, int.Parse(this.newSentiment), true);
